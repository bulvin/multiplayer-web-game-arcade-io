export class UI {
    ...
    drawScoreBoard() {
        ...
        this.setFillAndStroke('hsla(0, 0%, 0%, 0.8)', 'white', 0.3);
    ...
    drawStats() {
        ...
        const bgWidth = maxWidth + padding * padding;
        const bgHeight = lineHeight * lines + padding * 2 + textTopMargin;
        this.game.ctx.fillStyle = 'hsla(0, 0%, 0%, 0.8)';
        this.game.ctx.fillRect(x - padding, y - bgHeight + lineHeight + padding, bgWidth, bgHeight);
    ...
    drawAbilitiesUI() {
        ...
        for (let i = 0; i < countAbilities; i++) {
            ...
            this.setFillAndStroke('hsla(0, 0%, 0%, 0.8)', borderColor, borderWidth);
